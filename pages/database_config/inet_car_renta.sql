...
ALTER TABLE `tblpayment`
  ...
  ADD KEY `rental_id` (`rental_id`,`customer_id`);
...
--
ALTER TABLE `tblcustomercredential`
  MODIFY `credential_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tblownercredential`
  MODIFY `owner_credential_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
