  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        // Verificar si el valor de $car_id está vacío
        if (empty($car_id)) {
          echo "El valor de car_id está vacío";
          exit; // Otra acción adecuada, como redireccionar a otra página o mostrar un mensaje de error.
        }
