...
if(isset($_POST['username'])){
    ...
    $query = "SELECT COUNT(*) AS cnt_username FROM tblcustomer WHERE username='".$username."'";
    
    $result = mysqli_query($cn,$query);
    
    $response_username = "";
    echo "<script>
    document.getElementById('add-customer_btn').disabled = false;
    ...
    if(mysqli_num_rows($result)){
        ...
        if($count > 0){
            ...
            echo "<script>
            document.getElementById('add-customer_btn').disabled = true;
