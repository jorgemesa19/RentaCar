              ...
              <div class="col-4">
                  <div class="card text-center">    
                      <div class="card-body">
                          ...
                          <li class="list-group-item">
                              <button type="button" class='btn btn-sm btn-warning ' data-toggle='modal' data-target='#edit-profile_picture-<?php echo $user_id;?>'><i class='nav-icon fas fa-pen'></i> Edit Picture</button>
                          </li>
                      </ul>
                      </div>
                  </div>
                      ...
                      <div class="card">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <button type="button" class='form-control btn   btn-default ' data-toggle='modal' data-target='#edit-password-<?php echo $user_id;?>'>Change Password</button>
                          </div>
                      </div>
                          ...
                          <input type="submit" class="btn btn-primary" name="edit-user" value="Save">
                    </div>
                      </div>
                  </form>
              </div>
